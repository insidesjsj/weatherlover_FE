...
import cardigan from '../img/Clothes/cardigan.png'
import knit from '../img/Clothes/knit.png'
import coat from '../img/Clothes/coat.png'
import padding from '../img/Clothes/padding.png'
